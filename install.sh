...
author=wangapple121
# github=https://github.com/wangapple121/v2ray
...
is_sh_system_core_dir=$is_sh_dir/code/src
...
pass_args() {
    while [[ $# -gt 0 ]]; do
        case $1 in
        online)
            err "如果想要安装旧版本, 请转到: https://github.com/wangapple121/v2ray/tree/old"
            ;;
        -f | --core-file)
            [[ -z $2 ]] && {
...
main() {
    ...
    cp -rf $is_sh_system_core_dir $is_sh_dir/src
    cp $is_sh_dir/code/v2ray.sh $is_sh_dir
